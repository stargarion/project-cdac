...
<body>
	<div class="container-fluid"
		...
		<div>
			...
			<!--****************************body*************************************-->
			<div class="col-10">
				<spr:form action="stu_upl" modelAttribute="Login" class="pt-3">

					<div class="form-group">
						<spr:select path="firstname" class="form-control form-control-lg">
							<spr:option value="Batch"></spr:option>
							<spr:option value="Marks"></spr:option>
						</spr:select>
					</div>

					<div class="form-group" style="font-weight: bolder">
						Upload File : <spr:input type="file" path="address"
							class="form-control form-control-lg" style="opacity: 0.8" />
					</div>

					<div>
						<input type="submit" class="btn btn-danger btn-icon-text">
					</div>
				</spr:form>
			</div>
