				...
				********************RIGHT********************* -->
				<div class="mx-auto">
					<div class="auth-form-light text-left py-3 px-4 px-sm-5">
						...
						<spr:form action="pass_chan" modelAttribute="Login" class="pt-3">
							<spr:hidden path="id" id="id" value="<%=loggedUser1.getId()%>" />
							<div class="form-group">
								<spr:password path="firstname"
							...
							<div class="form-group">
								<spr:password path="lastname"
									class="form-control form-control-lg" id="repassword"
									placeholder="Confirm Password" required="true" onblur="conf()" />
								<!-- <input type="password" class="form-control form-control-lg"
									id="exampleInputPassword1" placeholder="Password"> -->
								<div class="alert" id="alert" hidden="true">Password don't
									match</div>
							</div>
