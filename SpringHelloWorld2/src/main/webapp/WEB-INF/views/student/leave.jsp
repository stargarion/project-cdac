	...
	<div class="container-fluid"
		...
		<div>
			...
			<spr:form action="leave_give" modelAttribute="Leaver"
				...
				<spr:hidden path="uid" value="<%=loggedUser1.getId()%>" />
				From: <spr:input type="date" path="startdate" required="true" />
				To: <spr:input type="date" path="enddate" required="true" />
				Reason for leave: <spr:input path="reason" required="true" />
