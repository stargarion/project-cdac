		...
		<div>
			...
			<div class="row"
				...
				<div class="card-body">
					...
					<spr:form action="update" class="form-sample" modelAttribute="login">
						<spr:hidden path="id" value="<%=loggedUser1.getId() %>"/>
						<spr:hidden path="password" value="<%=loggedUser1.getPassword() %>"/>
						<spr:hidden path="username" value="<%=loggedUser1.getUsername()%>"/>
						<spr:hidden path="userrole" value="<%=loggedUser1.getUserrole() %>"/>
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<spr:input path="lastname" type="text" id="in" class="form-control"
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group row">
									...
									<div class="col-sm-9">
									<label id="input1" class="form-control" style="background:#ced4da"><%=loggedUser1.getGender()%></label>
										 <spr:select path="gender" id="select" class="form-control" hidden="true" value="<%=loggedUser1.getGender()%>">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<spr:input path="email" type="text" class="form-control" value="<%=loggedUser1.getEmail()%>" disabled="true"/>
									</div>
								</div>
							</div>
							 <!-- <div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<spr:input path="phone" type="text" class="form-control" disabled="true" value="<%=loggedUser1.getPhone()%>"/>
									</div>
								</div>
							</div>
							<!-- <div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<spr:input path="address" type="text" class="form-control" disabled="true" value="<%=loggedUser1.getAddress()%>"/>
									</div>
								</div>
							</div>
							<!-- <div class="col-md-6">
